...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_F)
	{
		if (theWindow->articulacion1 < 45.0 && theWindow->bandera1 == 0) {
		...
		else if (theWindow->articulacion1 > -45.0 && theWindow->bandera1 == 1) {
			theWindow->articulacion1 -= 5.0;
		}
		else {
	...
	if (key == GLFW_KEY_G)
	{
		if (theWindow->articulacion2 < 45.0 && theWindow->bandera2 == 0) {
			theWindow->articulacion2 += 5.0;
		}else if (theWindow->articulacion2 == 45.0) {
			theWindow->bandera2 = 1;
			theWindow->articulacion2 -= 5.0;
		}else if (theWindow->articulacion2 > -45.0 && theWindow->bandera2 == 1) {
			theWindow->articulacion2 -= 5.0;
		}else {
	...
	if (key == GLFW_KEY_H)
	{
		if (theWindow->articulacion3 < 45.0 && theWindow->bandera3 == 0) {
			theWindow->articulacion3 += 5.0;
		}else if (theWindow->articulacion3 == 45.0) {
			theWindow->bandera3 = 1;
			theWindow->articulacion3 -= 5.0;
		}else if (theWindow->articulacion3 > -45.0 && theWindow->bandera3 == 1) {
			theWindow->articulacion3 -= 5.0;
		}else {
	...
	if (key == GLFW_KEY_J)
	{
		if (theWindow->articulacion4 < 45.0 && theWindow->bandera4 == 0) {
			theWindow->articulacion4 += 5.0;
		}else if (theWindow->articulacion4 == 45.0) {
			theWindow->bandera4 = 1;
			theWindow->articulacion4 -= 5.0;
		}else if (theWindow->articulacion4 > -45.0 && theWindow->bandera4 == 1) {
			theWindow->articulacion4 -= 5.0;
		}else {
	...
	if (key == GLFW_KEY_K)
	{
		if (theWindow->articulacion5 < 0.0 && theWindow->bandera5 == 0) {
			theWindow->articulacion5 += 5.0;
		}else if (theWindow->articulacion5 == 0.0) {
			theWindow->bandera5 = 1;
			theWindow->articulacion5 -= 5.0;
		}else if (theWindow->articulacion5 > -30.0 && theWindow->bandera5 == 1) {
			theWindow->articulacion5 -= 5.0;
		}else {
