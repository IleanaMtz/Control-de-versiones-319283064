...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, (mainWindow.getavanzar()*0.05)));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, (mainWindow.getretroceder() * 0.05)));
		...
		model = glm::translate(model, glm::vec3(0.7f, -0.3f, 1.55f));

		modelaux = model;

		model = glm::rotate(model, glm::radians(mainWindow.getavanzar()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getretroceder()), glm::vec3(1.0f, 0.0f, 0.0f));
