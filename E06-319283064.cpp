...
void CrearDado()
{
	...
	GLfloat cubo_vertices[] = {
		...
		-0.5f, -0.5f,  0.5f,	0.48f,	0.34f,		1.0f,	0.0f,	0.0f,
		-0.5f,  0.5f,  0.5f,	0.48f,	0.66f,		1.0f,	0.0f,	0.0f,
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado_animales_recortada.png");
	...
	Dado_M = Model();
	Dado_M.LoadModel("Models/cubo_animales.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(0.15f, 0.15f, 0.15));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Dado_M.RenderModel();
