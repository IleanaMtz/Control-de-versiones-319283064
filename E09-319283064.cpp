...
int main()
{
	...
	cuerpoDragonCompleto = Model();
	cuerpoDragonCompleto.LoadModel("Models/Cuerpo Dragon Completo.obj");
	alaDerecha = Model();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		cuerpoDragonCompleto.RenderModel();

		//Ala derecha
		modelaux = model;
		model = glm::translate(model, glm::vec3(-0.6f, 3.5f, -0.3));
