...
int main()
{
	...
	//CREAR VENTANA
	GLFWwindow *mainWindow = glfwCreateWindow(WIDTH, HEIGHT, "Ejercicio de Clase 1: Introduccion a OpenGL", NULL, NULL);
